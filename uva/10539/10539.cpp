...
//    P(cnt);
    sort(almostprime,almostprime+p);
//    dbgarr(almostprime,0,20);
}
...
int main()
{
    ...
    while(t--)
    {
        ...
        for0(i,p)
        {
            if(almostprime[i] >= l && almostprime[i] <= r)
                cnt++;
            else if(almostprime[i]>r)
                break;
//            P(cnt);
        }
